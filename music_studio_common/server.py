...
STUDIO_DIR = PROJECT_DIR / "children-music-studio" / "studio"
...
KNOWLEDGE_DIR = COMMON_DIR / "knowledge"
...
def configure_workspace(
    *,
    studio_dir: Path,
    frontend_music_dir: Path,
    demo_dir: Path,
) -> None:
    """Point the shared production engine at one of the two studio frontends."""
    global STUDIO_DIR, AUDIO_DIR, PROJECT_DIR, ENV_FILE, FRONTEND_MUSIC_DIR, DEMO_DIR
    global TASKS_DIR, JOBS_DIR, RECORDS_DIR, THEMES_DIR, THEME_DRAFTS_DIR
    global THEME_PREVIEWS_DIR, GENERATED_TASKS_DIR, DESIGN_PROJECTS_DIR

    STUDIO_DIR = studio_dir.resolve()
    AUDIO_DIR = STUDIO_DIR.parent
    PROJECT_DIR = AUDIO_DIR.parent
    ENV_FILE = PROJECT_DIR / ".env"
    FRONTEND_MUSIC_DIR = frontend_music_dir.resolve()
...
def run_server(*, default_port: int = 8766, port_env: str = "CHILDREN_MUSIC_STUDIO_PORT") -> int:
    load_local_env()
    parser = argparse.ArgumentParser()
    parser.add_argument("--port", type=int, default=int(os.environ.get(port_env, str(default_port))))
