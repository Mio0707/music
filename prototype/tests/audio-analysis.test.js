...
context.__render();
if (!appElement.innerHTML.includes("歌曲分析") || !appElement.innerHTML.includes("贴纸旋律创作")) throw new Error("教师备课首页没有同时显示两大功能");
context.__analysisState.teacherMode = "creation";
context.__render();
if (!appElement.innerHTML.includes("http://127.0.0.1:8766/")) throw new Error("儿童音乐设计台没有接入教师备课平台");
